                                    ...
                                    <div class="px-4 py-5 bg-white sm:p-6">
                                        @if ($currentPage === 1)
                                                <div class="w-full py-2">
                                                    ...
                                                    <input wire:model.lazy="memberName" type="text" name="memberName"
                                                        id="memberName" autocomplete="given-name"
                                        ...
                                        <div class="flex flex-col">
                                            <div class="w-full py-2">
                                                <label for="studentCard"
                                                    class="block text-sm font-medium text-gray-700">Student Card</label>
                                                <input wire:model.lazy="studentCard" type="text" name="studentCard"
                                                    id="studentCard"
                                                    class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                                @error('studentCard')
                                                    <span class="mt-1 text-xs text-red-500">{{ $message }}</span>
                                            ...
                                            <div class="flex flex-col">
                                                <div class="w-full py-2">
                                                    ...
                                                    <input wire:model.lazy="memberPosition" type="memberPosition" name="memberPosition" id="memberPosition"
                                                        class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
