    ...
    <div class="flex flex-wrap items-center sm:-mx-3">
      <div class="w-full md:w-1/2 md:px-3">
        <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
          <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
            <span class="block xl:inline">Socialize and </span>
            <span class="block text-indigo-600 xl:inline">Tell Your Story!</span>
          </h1>
          <p class="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">Club.io is the best way to keep <span class="text-purple-900 font-bold">advertize and track member involvement for your club.</span> </p>
      ...
      <div class="w-full md:w-1/2">
        <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
            <img src="https://images.pexels.com/photos/10646602/pexels-photo-10646602.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1">
          </div>
      </div>
    </div>
  </div>
...
<!-- Section 1 -->
<section class="px-2 bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100 pt-2 md:px-0">
