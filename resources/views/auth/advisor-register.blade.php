<x-guest-layout>
    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('advisor.register') }}">
            ...
            <!-- Name -->
            <div>
                <x-label for="advisor_id" :value="__('Advisor Card')" />

                <x-input id="advisor_id" class="block mt-1 w-full" type="text" name="advisor_card" :value="old('advisor card')" required autofocus />
            </div>
            <div class="mt-4">
